  ...
  return (
    <div className="mx-auto mt-0 min-h-screen w-full max-w-[85rem] bg-[#fff] text-left">
          ...
          <div className="flex flex-col items-center justify-between gap-20 lg:flex-row">
            <div className="w-full max-w-xl">
              ...
              <motion.div
                ...
                I developed an inventory management tool for Fisker
                Inc, an Electric Vehicle Company, to present product
                data to customers in a user-friendly manner. The
                algorithm I created displayed personalized vehicle
                features based on customer profiles. This tool
                generated 11,000+ leads and achieved a 10% conversion
                rate, totaling $41M+ in revenue.
              </motion.div>
      ...
      <motion.div
        ...
        <div class="object-fit h-96 w-full rounded-2xl bg-[url('https://d15k2d11r6t6rl.cloudfront.net/pub/bfra/81p7eutj/25r/tkr/695/Group%2060%20%282%29.png')] bg-cover bg-center bg-no-repeat sm:h-[650px] lg:object-contain"></div>
      </motion.div>
          ...
          <div className="flex flex-col items-center justify-between gap-20 lg:flex-row">
            ...
            <div className="inter-light w-full">
              <div className="text-[#000]">
                It began with a straightforward concept: finding a
                solution to offload excess inventory. I led the
                implementation of the tech stack and mapped the entire
                customer journey. From delivering personalized vehicle
                options to proactive abandoned cart follow-ups, the
                project yielded excellent results.
              </div>
            </div>
          </div>
        </div>
      ...
      <div
        ...
        <motion.div
          ...
          <div className="h-full overflow-hidden rounded-3xl object-cover">
            <img
              ...
              src="https://d15k2d11r6t6rl.cloudfront.net/pub/bfra/81p7eutj/bii/78r/9ri/Group%2064.png"
        ...
        <motion.div
          ...
          <div class="w-full">
            <img
              class="w-full rounded-3xl object-cover"
              src="https://d15k2d11r6t6rl.cloudfront.net/pub/bfra/81p7eutj/3vj/crm/kva/Group%2063.png"
              alt="Image Description"
            />
          </div>
        </motion.div>
