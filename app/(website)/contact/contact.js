      ...
      <motion.div
        ...
        <div>
          <form onSubmit={handleSubmit(onSubmit)} className="my-10">
            ...
            <button
              type="submit"
              className="oswald-medium w-full rounded-md bg-gray-900 px-7 py-4 font-semibold text-white transition-colors hover:bg-gray-800 focus:outline-none focus:ring focus:ring-gray-200 focus:ring-offset-2 dark:bg-white dark:text-black uppercase">
              {isSubmitting ? (
                <svg
