...
export default function NavbarV4({ posts }) {
  return (
    <div>
      <header class="z-50 flex w-full flex-wrap border-b border-gray-200 bg-white py-3 text-sm dark:bg-gray-800 sm:flex-nowrap sm:justify-start sm:py-0">
        <nav
