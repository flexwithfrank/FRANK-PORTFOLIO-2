...
export default function Badge({ titleText, value1, value2, value3, value4, value5  }) {
          ...
          <div class="text-left">
            ...
            <div class="mx-auto mt-4 flex max-w-2xl flex-wrap sm:mt-4">
              {Object.entries(badges).map(([text, value]) => (
                <div
                  key={text}
                  className="centima m-1 inline-flex cursor-pointer items-center gap-x-2 rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm uppercase text-[#ff3c00] shadow-md duration-300 ease-in-out hover:bg-[#ff3c00] hover:text-white hover:shadow-sm hover:transition-all disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-slate-900 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                  <svg
